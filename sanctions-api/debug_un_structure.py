# debug_un_structure.py
"""
Script para analizar la estructura real del XML de ONU
"""
import requests
import xml.etree.ElementTree as ET
from app.core.config import settings

def analyze_un_structure():
    """Analizar la estructura del XML de ONU"""
    
    print("🔍 Analizando estructura del XML de ONU...")
    
    # Descargar XML
    response = requests.get(settings.un_consolidated_url, timeout=60)
